        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    ...
                    .HasConstraintName("FK__CART__CustomerID__0B91BA14");
                ...
                entity.HasOne(d => d.ProductVariation)
                    ...
                    .HasConstraintName("FK__CART__ProductVar__0D7A0286");
            });
            ...
            modelBuilder.Entity<OrderTable>(entity =>
            {
                ...
                entity.HasOne(d => d.Product)
                    .WithMany(p => p.OrderTable)
                    .HasForeignKey(d => d.ProductId)
                    .HasConstraintName("FK__OrderTabl__Produ__10566F31");

                entity.HasOne(d => d.ProductVariation)
                    .WithMany(p => p.OrderTable)
                    .HasForeignKey(d => d.ProductVariationId)
                    .HasConstraintName("FK__OrderTabl__Produ__0F624AF8");
            });
